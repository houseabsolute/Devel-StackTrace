...
The code for this distribution is [hosted at GitHub](https://github.com/autarch/Devel-StackTrace).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Devel-StackTrace)
or [via email](bug-devel-stacktrace@rt.cpan.org.
